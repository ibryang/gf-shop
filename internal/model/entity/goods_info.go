...
type GoodsInfo struct {
	...
	Level1CategoryId int         `json:"level_1_category_id" description:"1级分类id"`
	Level2CategoryId int         `json:"level_2_category_id" description:"2级分类id"`
	Level3CategoryId int         `json:"level_3_category_id" description:"3级分类id"`
